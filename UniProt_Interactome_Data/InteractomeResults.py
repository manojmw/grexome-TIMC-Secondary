...
def Interactors_PValue(args):
    ...
    for ENSG_index in range(len(All_Interactors_list)):
        ...
        # Printing to STDOUT
        print('\t'.join(str(Intdata) for Intdata in Gene_AllPatho))
...
Arguments [defaults] -> Can be abbreviated to shortest unambiguous prefixes
    ...
    required.add_argument('--insamples', metavar = "Input File", dest = "inSample", help = 'Sample metadata file', required=True)
    ...
    required.add_argument('--incandidate', metavar = "Input File", dest = "inCandidateFile", nargs = '*', help = 'Candidate Genes Input File name(.xlsx)')
    required.add_argument('--incanonical', metavar = "Input File", dest = "inCanonicalFile", help = 'Canonical Transcripts file (.gz or non .gz)')
    ...
    required.add_argument('--incluster', metavar = "Input File", dest = "inClusterFile", help = 'Cluster output file produced by clustering methods (If required, processed by appropriate ProcessClusterFile_*.py script')
