...
my @keptColumns = qw(SYMBOL KNOWN_CANDIDATE_GENE Feature CANONICAL BIOTYPE Gene RefSeq INTERACTORS_COUNT INTERACTORS INTERACTORS_PVALUE ENRICHED_CLUSTER ENRICHED_CLUSTER_ID ENRICHED_CLUSTER_SIZE ENRICHED_CLUSTER_PVALUE);
...
my @keptColumnsSpecific = qw(KNOWN_CANDIDATE_GENE INTERACTORS_COUNT INTERACTORS INTERACTORS_PVALUE ENRICHED_CLUSTER ENRICHED_CLUSTER_ID ENRICHED_CLUSTER_SIZE ENRICHED_CLUSTER_PVALUE);
...
# INTERACTORS INTERACTORS_PVALUE ENRICHED_CLUSTER ENRICHED_CLUSTER_ID 
# ENRICHED_CLUSTER_SIZE ENRICHED_CLUSTER_PVALUE, currently)
my %transcript2start;
